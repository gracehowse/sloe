...
export const KNOWN_DEFAULT_OFF_FLAGS = [
  ...
  "contextual_help_v1", // ENG-1597 — loop-aware in-app help (ⓘ sheets + session-limited coach rails); off = no help affordances (kill switch). Web + mobile. Spec: docs/specs/2026-07-23-in-app-help-contextual-guidance.md.
] as const;
