...
import { StepperCircleButton } from "../ui/stepper-circle-button";
...
function AdjustConstraintsSheetLegacy({
  open,
  onOpenChange,
  initial,
  libraryCount,
              ...
              return (
                <button
                  ...
                  className={`flex-1 rounded-lg border py-2 text-sm font-bold ${
                    active
                      ? "border-primary-solid bg-primary-soft text-primary-solid"
...
function AdjustConstraintsSheetOwners({
  open,
  onOpenChange,
  initial,
  libraryCount,
  ...
  return (
    <SheetShell
      ...
      data-testid="adjust-constraints-sheet"
...
/** ENG-1665: owner chassis behind `ui_anatomy_owners_v1`. */
export function AdjustConstraintsSheet(props: AdjustConstraintsSheetProps) {
  if (!isFeatureEnabled(UI_ANATOMY_OWNERS_V1)) {
    return <AdjustConstraintsSheetLegacy {...props} />;
  }
  return <AdjustConstraintsSheetOwners {...props} />;
}
