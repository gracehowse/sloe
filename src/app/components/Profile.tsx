...
export const Profile = memo(function Profile({ userTier, displayName, onUpgrade, onOpenNutrition }: ProfileProps) {
  ...
  return (
    <div className="product-shell py-pm-5">
      ...
      <div className="flex items-center gap-3.5 mb-4 rounded-xl bg-card p-3.5 card-slab-flat">
        <div
      ...
      <div className="flex gap-2 mb-4">
        <div className="flex-1 text-center p-3 rounded-xl bg-card border border-border card-slab-flat">
      ...
      {householdSummary ? (
        <div className="mb-4">
          ...
          <div className="bg-card rounded-xl border border-border overflow-hidden card-slab-flat">
            <a
      ...
      {activeTab === "targets" && (
        <div className="space-y-8">
          {/* Macro Calculator */}
          <div className="bg-card border border-border rounded-xl p-4 card-slab-flat">
          ...
          {/* Calculated Targets */}
          <div className="bg-card border border-border rounded-xl overflow-hidden card-slab-flat">
