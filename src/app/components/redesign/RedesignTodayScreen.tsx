...
export function RedesignTodayScreen() {
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-2xl px-5 pb-32 pt-8 sm:px-6">
        {/* ── Header ─────────────────────────────────────────────── */}
          ...
          {(["day", "week"] as const).map((t) => {
            ...
            return (
              <button
                ...
                onClick={() => setTab(t)}
                className="rounded-full px-5 py-1.5 text-[13px] font-medium capitalize transition-colors"
                style={{
                  backgroundColor: active ? "var(--card)" : "transparent",
                  color: active ? "var(--foreground-brand)" : "var(--foreground-tertiary)",
                  boxShadow: active ? "0 1px 2px rgba(34,27,38,0.08)" : "none",
                }}
              >
                {t}
              </button>
          ...
          <div className="flex flex-col items-center gap-7 sm:flex-row sm:gap-8">
            ...
            <div className="flex w-full flex-1 flex-col gap-4">
              <div className="flex items-center gap-2">
                <Flame className="h-4 w-4" style={{ color: "#C8794E" }} aria-hidden />
                <span
          ...
          <ul className="flex flex-col">
            {MEALS.map((meal, i) => (
              ...
              >
                ...
                <span
                  className="shrink-0 text-[14px] tabular-nums font-medium"
        ...
        <section className="grid grid-cols-2 gap-4">
          <div className="flex items-center gap-3 rounded-[var(--radius-card-lg)] bg-card card-slab p-4">
            <span
              ...
              style={{ backgroundColor: "var(--macro-water-soft, rgba(90,138,153,0.12))", color: "var(--macro-water)" }}
              aria-hidden
            >
      ...
      <div className="pointer-events-none fixed inset-x-0 bottom-0 z-10 flex justify-center px-5 pb-6">
        <div
          ...
          style={{
            ...
            boxShadow: "0 8px 30px rgba(34,27,38,0.14)",
          }}
        >
          <button
