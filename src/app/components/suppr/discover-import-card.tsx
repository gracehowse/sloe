 ...
 *
 * ENG-1087 — the raised hero affordance (solid plum icon, serif title, "Paste
 * link" pill), unconditional since `discover_import_hero_v1` was collapsed
 * (ENG-1356) — the legacy aubergine soft-tint nav row it replaced is gone.
 * The whole slab opens the importer (`onOpenImport`). testID
