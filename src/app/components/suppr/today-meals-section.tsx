...
export function TodayMealsSection({
  ...
  // The kebab dropdown carries a quiet SupprMark + thumbnail/title/macro
  // header (mirroring mobile's MealActionSheet), and the usual-meal picker
  // carries the same brand mark. The desktop dropdown interaction is
  // preserved — a header band, never a grabber bottom sheet. The copy-meal
  // dialog carries the same chrome independently.
  // `redesign_branded_sheets` collapsed (ENG-1651): the flag was permanently
  // ON via REDESIGN_DEFAULT_ON, so this is the only chrome now — the legacy
  // bare dropdown/dialog is gone.
  ...
  return (
    <div className="mb-6" data-testid="today-meals-section">
                        ...
                        <DropdownMenu>
                          ...
                          >
                            ...
                            <DropdownMenuItem
                              ...
                              className="text-destructive focus:text-destructive mx-1 mb-1"
                            >
                              Delete
                            </DropdownMenuItem>
                          </DropdownMenuContent>
      ...
      >
        ...
        >
          <DialogHeader>
            {/* P5 parity (#6, #27) — quiet brand mark above the title,
                matching mobile's branded sheets. `redesign_branded_sheets`
                collapsed (ENG-1651) — permanently ON via REDESIGN_DEFAULT_ON. */}
            <span
