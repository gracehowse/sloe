  ...
  return (
    ...
    <div className="mb-3 rounded-card border border-primary/30 bg-primary/5 px-3.5 py-3 flex items-center gap-3 v2-fade-up">
      <div className="flex-1 min-w-0">
        ...
        {/* 2026-05-13 (premium-bar audit DC3 follow-up — TF screenshot
            showed "Salad & Stic…" mid-word truncation): allow up to 2
            lines + `break-words` so the title wraps at word boundaries
            before tail-clipping. `line-clamp-2` keeps long titles
            bounded so the banner can't grow unboundedly. */}
