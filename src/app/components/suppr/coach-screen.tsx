            ...
            {COACH_ASK_CHIPS.map((chip) => (
              <button
                ...
                className={cn(
                  ...
                  "rounded-full bg-card px-4 py-2 text-left text-sm font-medium text-foreground transition-colors",
                  "hover:bg-muted/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
                  selectedChipId === chip.id && "bg-primary-soft text-primary-solid",
                )}
              >
                {chip.label}
              </button>
