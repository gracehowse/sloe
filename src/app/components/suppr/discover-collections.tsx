      ...
      <div className="grid grid-cols-2 gap-3">
        {tiles.map((c) => (
          <button
            ...
            className="group flex aspect-[1.4] flex-col justify-end overflow-hidden rounded-card-lg p-3 text-left shadow-sm transition-transform active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
