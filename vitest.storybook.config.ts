...
export const STORYBOOK_UI_COVERAGE = [
  ...
  "src/app/components/ui/FatSecretBadge.tsx",
  "src/app/components/ui/icon-box.tsx",
  "src/app/components/ui/input.tsx",
  "src/app/components/ui/label.tsx",
  "src/app/components/ui/option-card.tsx",
  "src/app/components/ui/pressable-scale.tsx",
  "src/app/components/ui/progress.tsx",
  "src/app/components/ui/separator.tsx",
  "src/app/components/ui/settings-segmented.tsx",
  "src/app/components/ui/skeleton.tsx",
  "src/app/components/ui/skeleton-row.tsx",
  "src/app/components/ui/source-dot.tsx",
  "src/app/components/ui/sub-tab-pill.tsx",
