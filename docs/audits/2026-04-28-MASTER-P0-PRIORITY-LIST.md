...
27. ✅ **"More" exists nowhere on web.** **SHIPPED — Group G IA 5-batch plan complete (Batch E, 2026-05-14).** Decision: collapse You into 2 sub-tabs (Progress + Settings); Profile-as-row; kill standalone More tab. 5-batch plan in `docs/decisions/2026-04-28-group-g-ia-collapse.md`. Batch A shipped 2026-04-28 (pill collapse 3→2 mobile-web, commit a1b509e). Batch B shipped 2026-04-29 (mobile bundle extraction). Batch C shipped 2026-04-29 (web sidebar collapse + Settings header card). Batch D shipped 2026-04-30 — `/(tabs)/more` collapsed to a 17-line redirect. Batch E shipped 2026-05-14 — `more.tsx` deleted, all `/more` references purged from load-bearing code.
28. ✅ **Settings + More 80% overlap on native.** **SHIPPED — same plan as #27, Batch E complete 2026-05-14.** Native overlap collapsed in Batch B 2026-04-29 (shared bundle). Web parity shipped in Batch C 2026-04-29. `/more` redirect deleted in Batch E 2026-05-14. Group G IA collapse fully complete.
