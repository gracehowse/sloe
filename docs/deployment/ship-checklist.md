...
- [ ] **RevenueCat iOS (mobile):** RC project exists; Stripe is *not* used for mobile IAP (Pattern A — see `docs/decisions/2026-04-billing-architecture-pattern-a.md`). App Store Connect has four Pro/Base subscription SKUs; RC offering is live with monthly + annual packages; `EXPO_PUBLIC_REVENUECAT_APPLE_KEY` set in EAS.
