...
*reserved celebration* — it fires only at landmarks (day closed at/under
target, macro hit, streak milestone, and on the **Plan tab** when the week
hits 7/7). Never use `win` for ordinary confirmation. (ENG-796/820.)
