...
**Gaps (no dedicated journey doc yet — track in Maestro / matrix):** household (`household-settings`, Maestro flows under settings), Health Sync (`24_health_sync`), weight tracker (`14_weight_tracker`). See [`docs/qa/SCREEN_TEST_MATRIX.md`](../qa/SCREEN_TEST_MATRIX.md) for screen ↔ flow traceability.
