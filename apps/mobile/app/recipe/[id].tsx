...
import { useRecipeDetailStyles } from "@/components/recipe/useRecipeDetailStyles";
...
export default function RecipeDetailScreen() {
  ...
  const styles = useRecipeDetailStyles(colors, cardElevation, accent);
        ...
        <View style={styles.body}>
          ...
          {ingredientTextRows ? (
            <RecipeIngredientRows
              ...
              canDecrease={recipeDetailV3 ? viewServings > RECIPE_VIEW_SERVINGS_MIN : undefined}
              canIncrease={recipeDetailV3 ? viewServings < RECIPE_VIEW_SERVINGS_MAX : undefined}
              onDecrease={recipeDetailV3 ? () => handleViewServingsStep(-1) : undefined}
              onIncrease={recipeDetailV3 ? () => handleViewServingsStep(1) : undefined}
            />
          ) : (
            <RecipeIngredientGrid
              recipeId={recipeId}
