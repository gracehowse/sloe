...
import { TodayDashboardMacroTiles } from "./TodayDashboardMacroTiles";

const meta = {
  title: "Mobile/Today/TodayDashboardMacroTiles",
...
} satisfies Meta<typeof TodayDashboardMacroTiles>;

export default meta;
type Story = StoryObj<typeof meta>;

export const OnTrack: Story = {};
export const WithNutrientsLink: Story = { args: { showNutrientsLink: true, onPressNutrients: noop } };
