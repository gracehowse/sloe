 ...
 *   - 24pt rhythm above the disc; 12pt rhythm between elements.
 ...
 * still accepted. New props are additive.
 *
...
export interface EmptyStateProps {
  ...
  /** Optional 32pt-class lucide glyph rendered inside a 72pt
   ...
   *  `action`; alias added 2026-05-01 for parity with the web spec. */
  cta?: React.ReactNode;
  style?: ViewStyle;
