...
import { setCommunityShareConsent } from "@suppr/shared/foodCorrection/communityShareConsent";
...
export function BarcodeShareOptIn({
  ...
  const share = useCallback(async () => {
    setPhase("sharing");
    const consentResult = await setCommunityShareConsent(supabase, userId, true);
    if (!consentResult.ok) {
      setReasons([consentResult.error]);
      setPhase("blocked");
      return;
    }
