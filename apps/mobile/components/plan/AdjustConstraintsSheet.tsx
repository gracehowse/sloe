...
import { AdjustConstraintsSheetLegacy } from "./AdjustConstraintsSheet.legacy";
...
function AdjustConstraintsSheetOwners({
  ...
  return (
    <SheetShell
      ...
      onClose={onClose}
      animationType="fade"
      testID="adjust-constraints-sheet"
 ...
 * ENG-1665: owner chassis (`SheetShell` + `StepperCircleButton`) behind
 * `ui_anatomy_owners_v1`; legacy hand-rolled chrome when flag is off.
 */
