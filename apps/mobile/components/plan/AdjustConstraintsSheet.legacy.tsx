...
export interface AdjustConstraintsSheetLegacyProps {
  visible: boolean;
  onClose: () => void;
...
/** Pre–ENG-1665 hand-rolled sheet chrome (flag-off path). */
export function AdjustConstraintsSheetLegacy({
  visible,
  onClose,
  initial,
  libraryCount,
  ...
  saving = false,
  onSave,
}: AdjustConstraintsSheetLegacyProps) {
...
const styles = StyleSheet.create({
  ...
  rowSub: { ...Type.caption, marginTop: 4 },
  stepper: {
    flexDirection: "row",
    alignItems: "center",
...
export default AdjustConstraintsSheetLegacy;
