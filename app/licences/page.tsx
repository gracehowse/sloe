...
const CODE_LICENCES: Entry[] = [
  ...
  { name: "date-fns", licence: "MIT", purpose: "Dates", url: "https://github.com/date-fns/date-fns" },
  { name: "zod / react-hook-form / sonner / vaul / embla-carousel / recharts / motion / cmdk / input-otp", licence: "MIT", purpose: "Misc UI + form utilities", url: "https://www.npmjs.com/" },
