  ...
  return (
    ...
    >
        ...
        <section className="mb-10">
          ...
          <ul className="md:hidden space-y-2">
            {DATA_LICENCES.map((e) => (
              ...
              >
                <a
                  className="block font-semibold text-primary-solid underline"
                  href={e.url}
                  target="_blank"
            ...
            <table className="w-full text-xs border border-slate-200 dark:border-slate-800">
              ...
              <tbody className="[&>tr>td]:p-2 [&>tr]:border-t [&>tr]:border-slate-200 dark:[&>tr]:border-slate-800">
                {DATA_LICENCES.map((e) => (
                  <tr key={e.name}>
                    <td>
                      <a className="text-primary-solid underline" href={e.url} target="_blank" rel="noopener noreferrer">
                        {e.name}
                      </a>
                    </td>
                    <td>{e.licence}</td>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-3">
            ...
            <a className="text-primary-solid underline" href="https://opendatacommons.org/licenses/odbl/1-0/" target="_blank" rel="noopener noreferrer">
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400">
          ...
          {" "}&middot;{" "}
          <Link href="/dmca" className="text-primary-solid underline">DMCA</Link>
        </p>
    </TrustPageLayout>
  );
}
